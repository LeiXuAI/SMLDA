...
switch(transform_type)
    ...
    case 13 %wMLDAs with saliecy weight form of my work
        disp('wMLDAs--------------------');
        [P] = wMLDA_transform(X, Y, parameter, 6);
        
    case 14 %wMLDAs with saliency weight form and correlation of my work
        disp('wMLDAsc-------------------');
        [P] = wMLDA_transform(X, Y, parameter, 7);
        
    case 15 %wMLDAs with saliency weight form and entropy of my work
        disp('wMLDAse-------------------');
        [P] = wMLDA_transform(X, Y, parameter, 8);
        
    case 16 %wMLDAs with saliency weight form and fuzzy of my work
        disp('wMLDAsf-------------------');
        [P] = wMLDA_transform(X, Y, parameter, 9);  
    
    case 17 %wMLDAb with saliency weight form and binary of my work
        disp('wMLDAsb-------------------');
        [P] = wMLDA_transform(X, Y, parameter, 10);
    case 18 %wMLDAb with saliency weight form and dependence of my work
        disp('wMLDAsd-------------------');
        [P] = wMLDA_transform(X, Y, parameter, 11);
end
